...
def main():
    ...
    shutil.copy('./main_beam_BS2.py', pwd)
    shutil.copy('./data_feed.py', pwd)
    shutil.copy('./build_net.py', pwd)
    shutil.copy('./drone_image_beam_data_BS2_train.csv', pwd)
    shutil.copy('./drone_image_beam_data_BS2_val.csv', pwd)
    shutil.copy('./drone_image_beam_data_BS2_test.csv', pwd)
    ...
    train_dir = 'drone_image_beam_data_BS2_train.csv'
    val_dir = 'drone_image_beam_data_BS2_val.csv'
        ...
        for idx, n in enumerate(train_size):
            ...
            for epoch in range(num_epochs):
                ...
                if cur_accuracy > best_accuracy:
                    ...
                    net_name = checkpoint_directory  + '//' +  'resnet18_beam_BS2'
    ...
    test_dir = './drone_image_beam_data_BS2_test.csv'
    checkpoint_path = f'{checkpoint_directory}/resnet18_beam_BS2'   
