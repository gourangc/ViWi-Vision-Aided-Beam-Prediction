...
model = resnet18_mod(pretrained=True, progress=True, num_classes=128)
model = model.cuda()


checkpoint_path = 'saved_folder/beam_pred_BS1/checkpoint/resnet18_beam_BS1'
...
val_dir = './drone_image_beam_data_BS1_test.csv'
